...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('courses', function (Blueprint $table) {
            ...
            $table->string('classroom', 100)->nullable()->comment('教室位置');
            $table->string('schedule', 255)->nullable()->comment('上课时间安排');
            ...
            $table->index('status');
            $table->unique(['name', 'course_month', 'teacher_id'], 'uk_course_month_teacher');
        });
    }
